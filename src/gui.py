...
class CalculatorWindow(QWidget):
     ...
     def __init__(self):
          ...
          #Two separate expressions, one shows one display, one is for calculation
          ...
          #Display fault text, height, read-only mode, alignment, lenght
          ...
          #Place elements to desired position
